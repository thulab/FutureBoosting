...
regress_cols_path="configs/columns/shanxi/realtime/regress_ic27.json"
tsfm_cols_path="configs/columns/shanxi/realtime/tsfm_ic94.json"
...
model_name="pipeline_$(basename "$tsfm_cols_path" .json)_$(basename "$regress_cols_path" .json)_${tsfm_models}_${regression_tag}"
exp_name="shanxi/realtime/tsfm_ic94_regress_ic27_future"
