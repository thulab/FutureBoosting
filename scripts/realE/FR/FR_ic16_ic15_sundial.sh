...
data_path="/share/workspace/qiuyunzhong/DATA/RealE/V60/FR_merged.csv"
regress_cols_path="configs/columns/REALE/FR/regress_ic15.json"
tsfm_cols_path="configs/columns/REALE/FR/tsfm_ic16.json"

data_list_dir=configs/time/data_split_REALE
data_list=(
  "${data_list_dir}/REALE.json"
)
...
model_name="$(basename "$tsfm_cols_path" .json)_$(basename "$regress_cols_path" .json)_${tsfm_models}_${regression_tag}"
exp_name="REALE/FR"
