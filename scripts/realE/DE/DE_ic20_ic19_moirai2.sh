...
data_path="/share/workspace/qiuyunzhong/DATA/RealE/V60/DE_merged.csv"
regress_cols_path="configs/columns/REALE/DE/regress_ic19.json"
tsfm_cols_path="configs/columns/REALE/DE/tsfm_ic20.json"
